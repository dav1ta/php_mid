...
class QuestionController extends Controller
{
    ...
    public function save(QuestionRequest $request){
        //თავიდანვე ამ გზით წავედი რომ ერთ ფორმაში გამეკეთებინა როგორც კითხვის ასევე პასუხების ქონდა
        //ამ  შემთხვევაში ამაზე კარგი გზა ვერ მოვიფიქრე შესაქმნელად
    ...
    public function append(Request $request){
        ...
        foreach($answers as $answ){
            ...
            //ციკლის გარეთ არ მომცა ამის საშუალება
            if($counter == $all_ans){
